                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="../admin/articleEdit.php" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">文章ID</label>
                                        <input type="text" class="form-control" name="id" value="<?php echo $aLenth["id"]?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">文章名称</label>
                                        <input type="text" class="form-control" name="tittle" value="<?php echo $aLenth["tittle"]?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control data" name="data" value="<?php echo $aLenth["date"]?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control data" name="summary" value="<?php echo $aLenth["summary"]?>">
                                    </div>
                                    <div class="form-group">
