        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">轮播图修改</span>
                    <div class="description">A banner elements use in form, input, select, etc.</div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title">Input a new banner</div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="../admin/bannerEdit.php" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">图片ID</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12"><textarea id="content" name="content" class="form-control" rows="5"></textarea></div>
                                    </div>
                                    <input type="hidden" name="src" id="img">
                                    <input type="button" value="预览上传" id="upload" class="btn btn-default">
                                    <input type="submit" value="添加图片" id="add" class="btn btn-default">
                                </form>
                            </div>
                        </div>
                    </div>
