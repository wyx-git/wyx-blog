                                    ...
                                    <table class="table">
                                        ...
                                        <?php  foreach ($data as $v):?>
                                            <tr>
                                                ...
                                                <td><?php $data=$v["data"];
                                                    echo date("Y-m-d H:i:s",$data)?></td>
                                                <td>
                                                    <a href="../form/banneredit.php?id=<?php echo  $v["id"] ?>" class="btn btn-primary btn-success">修改</a>
                                                    <a href="../admin/bannerDelete.php?id=<?php echo  $v["id"] ?>" class="btn btn-primary btn-danger">删除</a>
                                                </td>
                                            </tr>
                                            <div class="col-sm-4">
                                                <div class="panel fresh-color panel-primary">
                                                    <div class="panel-heading">图片名：<?php echo  $v["message"]?></div>
                                                    <div class="panel-body" style="height: 200px">
                                                        <img src="../admin<?php echo $v["src"] ?>" alt="" height="170px">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php  endforeach;?>
