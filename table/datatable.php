...
$result1 = $db->query("SELECT COUNT(*) FROM discuss ");
            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">多看评论能够看清自己</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                    ...
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <?php  foreach ($discuss as $v):?>
                                            <tr>
                                                ...
                                                <td class="col-md-6"><?php echo $v["message"]?></td>
                                                <td class="center-block">
                                                    <a href="../admin/discussDelete.php?id=<?php echo  $v["id"] ?>" class="btn btn-primary btn-danger">删除</a></td>
                                            </tr>
                                        <?php  endforeach;?>
                                        </tbody>
                                    </table>
